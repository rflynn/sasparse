...
class TestParseDoesntCrash(unittest.TestCase):
    ...
    def test_macro_macro_call_variable(self):
        SASDoc.from_string('%IF "&LABELMAC" ne "" %THEN %&LABELMAC;  *HCC labels;').dump()
    ...
    @unittest.skipUnless(os.path.exists('corpus/test-parse-array.sas'), '')
    def test_parse_array(self):
        SASDoc.from_file('corpus/test-parse-array.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-control.sas'), '')
    def test_parse_control(self):
        SASDoc.from_file('corpus/test-parse-control.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-data.sas'), '')
    def test_parse_data(self):
        SASDoc.from_file('corpus/test-parse-data.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-do.sas'), '')
    def test_parse_do(self):
        SASDoc.from_file('corpus/test-parse-do.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-drop.sas'), '')
    def test_parse_drop(self):
        SASDoc.from_file('corpus/test-parse-drop.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-filename.sas'), '')
    def test_parse_filename(self):
        SASDoc.from_file('corpus/test-parse-filename.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-libname.sas'), '')
    def test_parse_libname(self):
        SASDoc.from_file('corpus/test-parse-libname.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-macros.sas'), '')
    def test_parse_macros(self):
        SASDoc.from_file('corpus/test-parse-macros.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-ods.sas'), '')
    def test_parse_ods(self):
        print(SASDoc.from_file('corpus/test-parse-ods.sas'))

    @unittest.skipUnless(os.path.exists('corpus/test-parse-options.sas'), '')
    def test_parse_options(self):
        SASDoc.from_file('corpus/test-parse-options.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-proc-cimport.sas'), '')
    def test_parse_proc_cimport(self):
        SASDoc.from_file('corpus/test-parse-proc-cimport.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-proc-datasets.sas'), '')
    def test_parse_proc_datasets(self):
        SASDoc.from_file('corpus/test-parse-proc-datasets.sas')

    @unittest.skipUnless(os.path.exists('corpus/test-parse-proc-export.sas'), '')
...
class TestDMRCorpus(unittest.TestCase):
    ...
    @unittest.skipUnless(os.path.exists('corpus/snf-profiles.sas'), '')
    def test_nocrash_snf_profiles(self):
        SASDoc.from_file('corpus/snf-profiles.sas')

    @unittest.skipUnless(os.path.exists('corpus/hospital-profiles.sas'), '')
    def test_nocrash_hospital_profiles(self):
        SASDoc.from_file('corpus/hospital-profiles.sas')

    @unittest.skipUnless(os.path.exists('corpus/awvcclfv6.sas'), '')
